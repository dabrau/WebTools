...
const defaultFoldIconComponent = ({ collapsed }) => {
  ...
  if (collapsed) return <img src={'./components/MagmaQuery/foldableTable/right.svg'} style={style} alt="right" />
  return <img src={'./components/MagmaQuery/foldableTable/left.svg'} style={style} alt="left" />
}
